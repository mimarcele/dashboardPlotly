...
df = pd.DataFrame({
    "Times": ["Flamengo", "Flamengo", "Flamengo", "Corinthians", "Corinthians", "Corinthians", "Fluminense",
              "Fluminense", "Fluminense", "São Paulo", "Vasco da Gama"],
    "Gols": [20, 16, 30, 3, 9, 10, 0, 2, 8, 5, 5],
    "Competições": ["Libertadores", "Copa do Brasil", "Brasileirão", "Libertadores", "Copa do Brasil", "Brasileirão",
                    "Libertadores", "Copa do Brasil", "Brasileirão", "Brasileirão", "Série B"]
})
...
app.layout = html.Div(children=[
    ...
    dcc.Dropdown(
        ...
        options=[
            ...
            {'label': 'Vasco da Gama', 'value': 'CRVG'}
        ],
        value='FLA',
    ),
...
def changeText(value):
    if (value) == 'FLA':
        ...
        return px.bar(df[df['Times'] == 'Vasco da Gama'], x="Times", y="Gols", color="Competições")
    else:
